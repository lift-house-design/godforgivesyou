...
$route['ask_for_forgiveness'] = 'site/ask'; 
$route['pray_with_us'] = 'site/pray'; 
$route['send_prayer'] = 'site/send_prayer'; 
$route['forgive_sins'] = 'site/forgive'; 
$route['forgive_confession'] = 'site/forgive_confession'; 
...
$route['prayer/(:num)'] = 'site/prayer/$1';
$route['prayers'] = 'site/prayers';
$route['prayers/(:any)'] = 'site/prayers/$1'; 
$route['best_prayers'] = 'site/top_prayers'; 
